...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./styles.css\");\n\n\nvar getCategories = __webpack_require__(/*! ./categories */ \"./categories.js\");\n\nvar getRandomChannels = __webpack_require__(/*! ./random */ \"./random.js\");\n\ngetCategories();\ngetRandomChannels();\n\n//# sourceURL=webpack:///./index.js?");
...
eval("var getRandomChannels = function getRandomChannels() {\n  var container = document.querySelector('#container');\n  document.addEventListener('DOMContentLoaded', function () {\n    fetch('http://localhost:3004/').then(function (res) {\n      return res.json();\n    }).then(function (data) {\n      for (var i = 0; i < data.length; i++) {\n        var title = document.createElement('div');\n        var name = document.createElement('div');\n        var text = document.createElement('div');\n        var button = document.createElement('button');\n        var a = document.createElement('a'); // zagolovok.classList.add('block');\n        // // name.classList.add('block');\n        // // text.classList.add('block');\n\n        title.append(data[i].title);\n        name.append(data[i].name);\n        text.append(data[i].text);\n        a.textContent = 'Подписаться';\n        a.href = '/channels/:id';\n        button.prepend(a);\n        container.append(title);\n        container.append(name);\n        container.append(text);\n        container.append(button);\n      }\n    });\n  });\n};\n\nmodule.exports = getRandomChannels;\n\n//# sourceURL=webpack:///./random.js?");
